    ...
    <main role="main" className="min-h-screen flex items-center justify-center bg-bg p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-primary mb-2">HXAI</h1>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {resetHint && (
                    <p className="text-xs text-text-muted">
                      Lupa password? Buka <code className="bg-sidebar px-1 rounded">hxrouter</code> CLI di host → <b>Settings</b> → <b>Reset Password to Default</b>.
                    </p>
                  )}
                </div>
