# Custom Logic — HXAI (9router Fork)
...
### Files
- `src/app/layout.js` — Title: "HXAI - AI Infrastructure Management"
- `src/dashboardGuard.js` — API welcome: "Welcome to HXAI! Use {baseUrl}/v1 as your API endpoint."
...
| `src/app/layout.js` | HXAI branding + upstream GA/font script |
