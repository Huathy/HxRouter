...
- `skipped + reason`: intentionally not ported because it would overwrite HxRouter custom behavior or is outside Kimchi/shared contract scope.
...
## Custom HxRouter protection matrix
