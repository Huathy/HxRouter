 ...
 * API. They are HxRouter fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic HxRouter variant set for a single upstream Kiro model.
 *
 ...
 * into HxRouter variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
