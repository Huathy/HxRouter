 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what HxRouter needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are an HxRouter
...
/**
 * Detect whether a model id refers to an HxRouter synthetic agentic variant.
...
/**
 * Detect whether a model id is an HxRouter synthetic thinking variant
...
/**
 * Resolve an HxRouter model id to the real upstream Kiro model id, plus flags
