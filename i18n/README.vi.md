...
<div align="center">
  ...
  **Nhà cung cấp AI Miễn cho OpenClaw.**
  ...
  [🚀 Bắt đầu nhanh](#-quick-start) • [💡 Tính năng](#-key-features) • [📖 Cài đặt](#-setup-guide) • [🌐 Website](https://hxrouter.com)
</div>
...
Gói kho lưu trữ này là riêng tư (`hxrouter-app`), vì vậy việc thực thi nguồn/Docker là đường dẫn phát triển cục bộ dự kiến.
...
| `CLOUD_URL` | `https://hxrouter.com` | URL cơ sở endpoint đồng bộ đám mây phía máy chủ |
| `NEXT_PUBLIC_BASE_URL` | `http://localhost:3000` | URL cơ sở tương thích ngược/công khai (ưu tiên `BASE_URL` cho runtime máy chủ) |
| `NEXT_PUBLIC_CLOUD_URL` | `https://hxrouter.com` | URL đám mây tương thích ngược/công khai (ưu tiên `CLOUD_URL` cho runtime máy chủ) |
...
- Xác minh `CLOUD_URL` trỏ đến endpoint đám mây dự kiến của bạn (ví dụ: `https://hxrouter.com`)
...
- Triệu chứng thường xuất hiện trên endpoint đám mây công khai (`https://hxrouter.com/v1`) cho các lệnh gọi không phát trực tiếp (non-streaming).
...
- `tester/security/test-cloud-openai-compatible.sh`
  - Gửi một yêu cầu tương thích OpenAI trực tiếp đến endpoint đám mây (`https://hxrouter.com/v1/chat/completions`) với mô hình/key được cung cấp.
...
- Endpoint đám mây công khai (`https://hxrouter.com/v1/chat/completions`):
...
- **GitHub**: [github.com/decolua/9](https://github.com/Huathy/HxRouter)
...
[![Contributors](https://contrib.rocks/image?repo=decolua/9router&max=100&columns=20&anon=1)](https://github.com/Huathy/HxRouter/graphs/contributors)
...
Xem [Pull Requests](https://github.com/Huathy/HxRouter/pulls) để biết hướng dẫn chi tiết.
