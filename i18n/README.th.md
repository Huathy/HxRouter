...
| 🧠 **Inline Context Compression** ([thincontext](https://www.npmjs.com/package/thincontext)) | บีบอัด system/tool context ซ้ำในโปรเซสก่อนเลือกผู้ให้บริการ | ประหยัดโทเค็นบริบทโดยไม่ต้องมี sidecar |
...
การบีบอัดบริบททำงานภายในโปรเซส Node ของ 9Router โดยใช้ `thincontext` ระบบจะลด system/tool context ที่ซ้ำกันก่อนเลือกผู้ให้บริการตามปกติ หากไม่ปลอดภัยหรือเกิดข้อผิดพลาด ระบบจะส่งคำขอต้นฉบับต่อแบบ fail-open ไม่ต้องติดตั้ง sidecar หรือ Python
